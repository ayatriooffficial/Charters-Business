     ...
     <>
       ...
       {open && (
         <div className="fixed bottom-3 right-3 z-50 flex h-[530px] w-[360px] max-w-[95vw] flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white/90 shadow-[0_20px_60px_rgba(0,0,0,0.15)]">
           <div className="flex items-center justify-between border-b border-gray-200 bg-white/80 px-3 py-3">
           ...
           <div className="flex-1 space-y-4 overflow-y-auto bg-white px-4 py-4">
             {messages.map((msg, index) => (
               ...
               >
                 ...
                 <div
                   className={`max-w-[95%] break-words whitespace-pre-wrap rounded-xl px-4 py-3 text-sm leading-relaxed ${
                     msg.sender === "user"
                       ...
                       a: ({ href, children }) => {
                         ...
                         return (
                           <a
                             ...
                             target="_blank"
                             rel="noreferrer"
                             className={`block w-full rounded-lg px-4 py-2.5 text-center text-sm font-medium shadow-sm transition ${
                               isWhatsapp
