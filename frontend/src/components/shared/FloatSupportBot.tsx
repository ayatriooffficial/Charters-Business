      ...
      {open && (
        ...
        z-50 flex flex-col overflow-hidden">
          ...
          <div className="flex items-center justify-between px-3 py-3 border-b border-gray-200 bg-white/80">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex">
                  <p className="font-semibold text-black text-[14px]">Ragini </p>
                </div>
                <div className="flex flex-row align-middle">
                  <span className="text-gray-600 text-[14px]"> AI Admission Counsellor </span>
                </div>
              </div>
            </div>
        ...
        ${isWhatsapp
          ...
          <div className="p-4 bg-[#ffffff]">
            <div className="flex w-full px-4 py-[6px]  rounded-full 
                 border border-gray-300 text-sm 
                 outline-none">
              <img src="Charters icon/AI-icon.svg" className="w-[25px] h-[25px] pt-[3px]" />
              <input
                value={input}
                onChange={(e) => setInput(e.target.value)}
                placeholder="Ask a question…"
                className="ml-[10px] w-full h-[30px] outline-none"
