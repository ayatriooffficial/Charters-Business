            ...
            {isVisible && (
                <>
                    <div className="flex-shrink-0 text-center mb-13 sm:mb-13">
                        ...
                        <div className="flex flex-nowrap justify-center items-center gap-6 sm:gap-10 mt-4 sm:mt-6 overflow-x-auto">
                            {heading_description.description.split("|").map((item: string, index: number) => (
                                <div key={index} className="flex items-center gap-2 flex-shrink-0">
                                    <img
                                        ...
                                        aria-hidden="true"
                                    />
                                    <span className="text-sm sm:text-base text-black font-medium whitespace-nowrap">
                                        {item.trim()}
                                    </span>
                                </div>
                            ))}
