...
function SevenBusinessesComponent() {
  ...
  return (
    <>
      ...
      <section
        ref={sectionRef}
        className="relative mt-16 z-[5] bg-white text-black full-bleed-section"
        role="region"
      ...
      >
        ...
        {isVisible && (
          ...
          <div className="w-full">
            ...
            <div className="px-4 sm:px-6 lg:px-8 xl:px-12 flex flex-col items-center mb-8 sm:mb-12 lg:mb-16 text-center">
              <p className="text-sm font-semibold text-[#B30437] tracking-wider mb-4 sm:mb-6" role="text">
                LEARN BY BUILDING
              </p>

              <h2 id="businesses-heading" className="leading-none px-[20px] text-black text-2xl sm:text-3xl md:text-[35px] font-bold pb-[17px]">
              ...
              <div className="flex justify-center">
                <p className="text-black text-sm sm:text-base md:text-lg max-w-2xl leading-relaxed" role="doc-subtitle">
                  ...
                  and explore the ins and outs of 30+ industries.
                </p>
              </div>
            </div>
            ...
            {/* Carousel Navigation */}
            <nav
              className="flex space-x-2 sm:space-x-3 justify-end mb-4 sm:mb-6 px-4 sm:px-6 lg:px-8 xl:px-12"
              role="navigation"
              aria-label="Business carousel navigation"
            >
              ...
              <button
                ...
                type="button"
              >
                <img src="/Charters-icon/Cancel.svg" alt="icon" width={12} height={12} className="w-5 h-5 sm:w-6 sm:h-6 text-white" aria-hidden="true" />
              </button>
            ...
            {/* Carousel - Full viewport width, edge-to-edge */}
            <div
              className="relative overflow-x-auto overflow-y-hidden scrollbar-hide cursor-grab active:cursor-grabbing w-full"
              role="region"
            ...
            >
              ...
              >
                ...
                {businesses.map((business, index) => (
                  ...
                  <article
                    key={index}
                    className="flex flex-col flex-shrink-0 w-[85vw] sm:w-[70vw] md:w-[45vw] lg:w-[30vw] xl:w-[calc((100%-48px)/3.5)] first:ml-4 first:sm:ml-6 first:lg:ml-8 first:xl:ml-12"
                    role="article"
                  ...
                  >
                    ...
                    <div className="mb-3 sm:mb-4">
                      ...
                      <div className="w-full h-0.5 bg-[#B30437]/70 mt-2"></div>
                    </div>
                      ...
                      <figcaption className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 bg-gradient-to-t from-black/70 to-transparent">
                        ...
                        {business.showProgress && (
                          <div className="flex items-center mt-3">
                            <span className="text-[#B30437] text-xs sm:text-sm font-medium">
