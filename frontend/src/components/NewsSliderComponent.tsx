  ...
  const defaultNews: NewsItem[] = [
    {
      ...
      title: "Kolkata's 1st marketing and accounting training institution with 100% Placement Achievement in 2025 across 7 countries",
      description: "Kolkata's 1st marketing and accounting training institution with 100% Placement Achievement in 2025 across 7 countries",
      link: "#",
    },
    {
      id: 2,
      ...
      title: "Kolkata-1st-marketing-and-accounting-training-institution-with-100%-Placement-Achievement-in-2025-across-7-countries-",
