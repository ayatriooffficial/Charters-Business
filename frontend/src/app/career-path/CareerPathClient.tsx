      ...
      <div className="h-screen flex">
        ...
        <main className="flex-1 min-w-0 flex flex-col bg-white">
          ...
          <footer className="h-24 shrink-0 border-t border-pink-100 bg-white flex items-center justify-between px-10 lg:px-16">
            <p className="text-[#80868b] font-medium">Step {step + 1} of {steps.length}</p>
    ...
    <>
      ...
      <div className="min-h-screen bg-white text-[#1f2937] font-sans">
        <div className="shrink-0 border-b border-pink-100 bg-white px-10 py-2 flex items-center gap-1 text-xs text-[#80868b]">
          ...
          <div className="bg-white border-b border-pink-100 px-10 py-2 flex items-center gap-1 text-xs text-[#80868b]">
            <Link href="/" className="hover:text-[#B30437] transition-colors font-medium">Home</Link>
            <span>{'>'}</span>
            <span className="text-[#5f6368] font-semibold">Career Path</span>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 mt-14">
            ...
            <div className="space-y-5">
              ...
              <div className="bg-[#fff7f9] border border-pink-100 rounded-2xl p-8">
                ...
                <p className="text-xs text-[#80868b] mt-3">LinkedIn Work Trend Index, 2024</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-[#fff7f9] border-y border-pink-100">
          <div className="max-w-7xl mx-auto px-8 lg:px-20 py-20">
            ...
            <p className="text-[#5f6368] text-lg mt-3">Based on what you&apos;ve shipped, your DSA depth, and how you use AI today.</p>
        ...
        <section className="max-w-7xl mx-auto px-8 lg:px-20 py-20">
          ...
          <p className="text-[#5f6368] text-lg mt-3">One is free. One is faster. Both work.</p>
        ...
        <section className="bg-[#fff7f9] border-y border-pink-100">
          <div className="max-w-7xl mx-auto px-8 lg:px-20 py-20">
            ...
            <p className="text-[#5f6368] text-lg mt-3">All have free tiers. Start using them this week.</p>
      ...
      {showLogin &&
        createPortal(
          <div className="fixed inset-0 flex items-start justify-center pt-16 z-[999999] bg-[#202124]/30">
